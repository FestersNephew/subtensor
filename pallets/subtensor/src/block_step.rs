...
impl<T: Config> Pallet<T>
{
        ...
        for (netuid, tempo) in <Tempo<T> as IterableStorageMap<u16, u16>>::iter()
        {
            ...
            let mut remaining = I96F32::from_num(new_queued_emission);
            {
                ...
                if subnet_has_owner
                {
                    ...
                    // --- 4. Shave their cut off the pending emissions
            ...
            let emission_to_drain: u64;
            {
                // First drain the queued emission.
                emission_to_drain = PendingEmission::<T>::get(netuid);
            ...
            {
                emission_tuples_this_block = Self::epoch(netuid, emission_to_drain);
    ...
    //
    pub fn adjust_difficulty(netuid: u16, current_difficulty: u64, registrations_this_interval: u16, target_registrations_per_interval: u16) -> u64
    {
    ...
    //
    pub fn adjust_burn(netuid: u16, current_burn: u64, registrations_this_interval: u16, target_registrations_per_interval: u16) -> u64
    {
